      ...
      <div className="bg-gray-200">
        ...
        <div className="container py-12 text-lg text-gray-700">
          ...
          <p className="mt-2 max-w-[70ch]">
            Sarah Schülke, Helmholtzstraße 37, 10587 Berlin
          </p>
          <h2 className="mt-6 font-serif text-2xl font-semibold">Kontakt</h2>
          <p className="mt-2 max-w-[70ch]">kontakt@sarahschuelke.de</p>
          <p className="max-w-[70ch]">www.sarahschuelke.de</p>
          <p className="max-w-[70ch]">+49 (0) 151 50300058</p>
          <h2 className="mt-6 font-serif text-2xl font-semibold">
            Redaktionell Verantwortliche
          </h2>
          <p className="mt-2 max-w-[70ch]">Sarah Schülke</p>
          <h2 className="mt-6 font-serif text-2xl font-semibold">
